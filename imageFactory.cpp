...
//    std::map<std::string, std::vector<SDL_Surface*>>::const_iterator msptr = multiSurfaces.begin();
//    unsigned int i = 0;
//    while (msptr != multiSurfaces.end() ){
//        while( i < msptr->second.size()){
//            SDL_FreeSurface(msptr->second[i]);
//            ++i;
//        }
//        ++msptr;
//    }
...
//    std::map<std::string, std::vector<SDL_Texture*>>::const_iterator mtptr = multiTextures.begin();
//    i = 0;
//    while ( mtptr != multiTextures.end() ){
//        while ( i < mtptr->second.size() ){
//            SDL_DestroyTexture(mtptr->second[i]);
//            ++i;
//        }
//        ++mtptr;
//    }
...
//    std::map<std::string, std::vector<Image*>>::const_iterator miptr = multiImages.begin();
//    i = 0;
//    while ( miptr != multiImages.end() ){
//        std::cout << "deleting " << miptr->first << std::endl;
//        while( i < miptr->second.size() ){
//            delete miptr->second[i];
//            ++i;
//        }
//        ++miptr;
//    }
